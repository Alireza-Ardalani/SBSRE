...
public class BadSmellsMenu implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			...
			else if(action.getId().equals("gr.uom.java.jdeodorant.actions.SingleResponsibilityViolation")) {
				page.showView("gr.uom.java.jdeodorant.views.SingleResponsibilityViolation");
			}
