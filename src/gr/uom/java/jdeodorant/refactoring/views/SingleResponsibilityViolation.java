...
public class SingleResponsibilityViolation extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		column6.setText("Slicing Algorithm");
		...
		treeViewer.setColumnProperties(new String[] {"Slicing Algorithm","type", "source", "variable", "block", "duplicationRatio", "rate"});
		...
		if(methodObject.getMethodBody() != null) {
			...
			if(numberOfStatements >= minimumMethodSize) {
				...
				*/
				...
				for(PlainVariable variable : targetList) {
					PDGObjectSliceUnionCollection objectSliceUnionCollection = new PDGObjectSliceUnionCollection(pdg, variable,0);
					double sumOfExtractedStatementsInGroup = 0.0;
					double sumOfDuplicatedStatementsInGroup = 0.0;
					double sumOfDuplicationRatioInGroup = 0.0;
					int maximumNumberOfExtractedStatementsInGroup = 0;
				...
				for(VariableDeclaration declaration : pdg.getVariableDeclarationsAndAccessedFieldsInMethod()) {
					PlainVariable variable = new PlainVariable(declaration);
					PDGObjectSliceUnionCollection objectSliceUnionCollection = new PDGObjectSliceUnionCollection(pdg, variable,1);
					double sumOfExtractedStatementsInGroup = 0.0;
					double sumOfDuplicatedStatementsInGroup = 0.0;
					double sumOfDuplicationRatioInGroup = 0.0;
					int maximumNumberOfExtractedStatementsInGroup = 0;
